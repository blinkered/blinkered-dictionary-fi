# Blinkered dictionary: Finnish

The Finnish word list, and the evidence for every word in it.

Built by [`blinkered-attestation`](https://github.com/blinkered/blinkered-attestation). The rule,
the evidence format and the reasoning live there; what lives here is Finnish.

**42,609 of 44,104 candidates proved — 96.6%**, across 7 independent
families, 5 of which a stranger could check by fetching.

## What is in this repository

```
sources.mjs        which collections attest Finnish, and why those
...
Candidates come from Blinkered's Finnish list, which lives in
[`blinkered-attestation/candidates/fi`](https://github.com/blinkered/blinkered-attestation/tree/main/candidates/fi).
